                                ...
                                <WrapperDetail>
                                    <DetailContainer style={{ width: "fit-content" }}>
                                        ...
                                        <Width10>
                                            ...
                                            <OverviewTitle>
                                                <OverviewSpan style={{ color: "rgb(24, 199, 191)", marginLeft: "0", width: "fit-content" }}>genres</OverviewSpan>
                                                <OverviewSpan>
                                            ...
                                            {detailsData?.production_companies &&
                                                <OverviewTitle>
                                                    ...
                                                    {detailsData?.production_companies?.slice(0, 6).map((i) => {
                                                        return <OverviewSpan key={i.id}>{i.name}{
                                                            detailsData?.production_companies?.indexOf(i) === 5 ? `.` : `,`}</OverviewSpan>
